/**
 * Footer Component - Modern E-commerce Footer Design with Tailwind CSS
 */
  ...
  return (
    <footer className="bg-gray-900 text-white">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-2xl font-bold">EcomMulti</span>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3 text-gray-400">
                  ...
                  <span>support@ecommulti.com</span>
                </div>
                <div className="flex items-center space-x-3 text-gray-400">
            ...
            >
              <h3 className="text-lg font-semibold mb-4 capitalize">
                {category === 'company' ? 'Company' : 
                 ...
                 category === 'legal' ? 'Legal' : 'Categories'}
              </h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center space-x-4 text-gray-400 text-sm mb-4 md:mb-0">
              <span>© 2024 EcomMulti. All rights reserved.</span>
              <span className="hidden sm:inline">•</span>
              <span className="flex items-center">
                Made with <HeartIcon className="h-4 w-4 text-red-500 mx-1" /> by our team
              </span>
            </div>
            ...
            <div className="flex items-center space-x-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center hover:bg-gray-700 transition-colors duration-200"
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 z-50 flex items-center justify-center"
