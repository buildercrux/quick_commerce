...
import { MapPin, Phone, Store, User, AlertCircle, Loader2, RefreshCw, ExternalLink } from 'lucide-react'
  ...
  const fetchNearbySellers = async (lat, lng, radius = searchRadius) => {
    try {
      ...
      if (response.ok) {
        ...
        console.log('🔍 Nearby sellers API response:', data)
        console.log('📊 Seller details payload:', data.data.user)
        
        // Log each seller's details individually
        if (data.data && data.data.length > 0) {
          console.log('📋 Individual seller details:')
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover local sellers in your area for faster delivery and better service
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sellers.map((seller, index) => (
            <motion.div 
              ...
              className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-6 border border-gray-200 cursor-pointer group relative"
            >
              {/* Seller Header */}
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-500">Click to view products</span>
